...
// conn.initiateConnection({ port: 102, host: '10.10.10.3', rack: 0, slot: 1, debug: true }, connected); // slot 2 for 300/400, slot 1 for 1200/1500, change debug to true to get more info
conn.initiateConnection({ port: 102, host: '10.10.10.3', localTSAP: 0x0200, remoteTSAP: 0x0300, timeout: 10000, doNotOptimize: true }, connected);
