...
def coco80_to_coco91_class():  # converts 80-index (val2014) to 91-index (paper)
    ...
    # a = np.loadtxt('resources/coco.names', dtype='str', delimiter='\n')
    # b = np.loadtxt('resources/coco_paper.names', dtype='str', delimiter='\n')
...
def non_max_suppression_mask_conf(prediction, attn, bases, pooler, hyp, conf_thres=0.1, iou_thres=0.6, merge=False, classes=None, agnostic=False, mask_iou=None,
                                  vote=False):
    ...
    for xi, x in enumerate(prediction):  # image index, image inference
        ...
        pooled_bases = pooler(base[None], [box])
