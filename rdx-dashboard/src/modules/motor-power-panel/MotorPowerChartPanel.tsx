...
export function MotorPowerChartPanel() {
    ...
    const chartTitle = "Motor Power Monitoring";
    const chartDescription = "Real-time motor power consumption";
    const trendText = "Current power consumption within normal range";
