...
export function SpinlePowerChartPanel() {

    const { data: gaugeSeriesValue } = useSWRSubscription('ws://192.168.0.166:4000/machine/state/spindle-power/series/ws', (key, { next }) => {
